# SHP Firefox Extension

Firefox Extension for this secure HTTP proxy.
...
## Load extension to Firefox

1. Open Firefox and go to `about:debugging#/runtime/this-firefox`
2. Click **Load Temporary Add-on...**
3. Select `manifest.json` (or any output asset in the `dist` directory)
